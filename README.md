...
The data is available for download from the Rwanda National Institute of Statistics (NISR) website: https://www.statistics.gov.rw/ - it is necessary to create an account to access the microdata files but summary tables are readily available without an account.
